...
async function checkDemographics() {
  console.log("Checking meta_demographics table...");
  ...
  if (error) {
    console.error("Error fetching meta_demographics:", error.message);
  } else {
    console.log("Data in meta_demographics:", JSON.stringify(data, null, 2));
  }
}
